...
//            fileName = URLEncoder.encode(fileName, "utf-8");
            commodity.setCommodityOtherImgUrls(commodity.getCommodityImg());
    ...
    @Override
    public boolean editCommodity(CommodityDo commodity) {
        commodityDoMapperExt.updateByPrimaryKey(commodity);
        return true;
    }
