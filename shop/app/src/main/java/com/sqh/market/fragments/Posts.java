...
public class Posts extends Fragment {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case 1:
                    //网络请求商品类别返回成功时，初始化控件
                    //绑定数据以及设置Adapter
                    postsAdapter = new PostsAdapter(postList, getActivity());
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        postListView = view.findViewById(R.id.list_posts);
        mProgressBar = view.findViewById(R.id.progress);
        btnSendPosts = view.findViewById(R.id.btn_send_posts);
    ...
    private void getDataFromServer() {
        String myid = String.valueOf(SharedPreferencesUtil
                .get(getActivity(), "userInfo", "userId", 0));

        String postsUrl = Constants.BASE_URL + Constants.GET_POSTS_URL + "?limit=9999999&page=1&userId="+myid+"&yesMine=0";
