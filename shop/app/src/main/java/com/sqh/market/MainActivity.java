            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                switch (checkedId) {
                    ...
                    case R.id.imageButton4:
                        ...
                        //为购物车刷新数据
                        ((Cart)mFragments.get(3)).initData();
                        break;
