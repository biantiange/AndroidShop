...
public class Constants {
     ...
     * web端基础地址
     */
    public static final String BASE_URL = "http://zefan.f3322.org:58080";
    //本地测试url
     ...
     * 发帖接口
     */
    public static final String POST_URL = "/post/addPost";

    /**
     * 获取帖子接口
     */
    public static final String GET_POSTS_URL = "/post/getPosts";

    /**
     * 删除帖子接口
     */
    public static final String DELETE_POSTS_URL = "/post/deletePost";

    /**
     * 点赞接口
     */
    public static final String ADD_PRAISE_URL = "/post/addPraise";

    /**
     * 取消点赞接口
     */
    public static final String DELETE_PRAISE_URL = "/post/deletePraise";

    /**
     * 添加帖子评论接口
     */
    public static final String SEND_REPLY_URL = "/control/addComment";

    /**
     *  删除帖子评论接口
     */
    public static final String DELETE_REPLY_URL = "/control/deleteComment";

    /**
     * 获取帖子点赞数接口
     */
    public static final String GET_PRAISE_URL = "/post/queryPraiseCount";
     ...
     * 根据商品id获取商品规格
     */
    public static final String GET_SPEC_BY_ID_URL = "/business/findSpecsByCommodityId?commodityId=";

    /**
     * 根据商品id获取评论数目Url
     */
    public static final String GET_COMMENT_NUMBER_URL = "/control/searchCommentNumber?commodityId=";
