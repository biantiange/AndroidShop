...
//                case 0:
//                    //网络请求成功，但是返回状态为失败
//                    Toast.makeText(mContext, msg.obj == null ? "请求处理失败！获取商品数目失败！"
//                            : msg.obj.toString(), Toast.LENGTH_SHORT).show();
//                    break;
//                case 1:
//                    //更改页面 评论数UI
//                    commentNumber.setText("(" + msg.arg1 + ")");
//                    break;
//                default:
//                    break;
//            }
...
//     * 初始化评论数目
//     * {获取失败：不做操作（默认为0）；
//     * 获取成功：修改 commentNumber 对应的 text}
//     */
//    private void initCommentNumber() {
//        //构造url
//        String url = Constants.BASE_URL
//                + Constants.GET_COMMENT_NUMBER_URL
//                + productId;
//
//        //发起网络请求
//        NetUtil.doGet(url
...
//                            int commentNumber = JSON.parseObject(com.alibaba
//                                            .fastjson.JSONObject.toJSONString(obj.get("data"))
//                                    , Integer.class);
//                            message.what = 1;
//                            message.arg1 = commentNumber;
//                        } else {
//                            message.what = 0;
//                        }
//
...
//    }
        ...
        mBtnBuy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (LoginCheckUtil.isLogin(DetailsActivity.this)) {
                    MyCartDialog dialog = new MyCartDialog(DetailsActivity.this,jsonArr);
    ...
    private void initCommodityData() {
        ...
        String url = Constants.BASE_URL
                ...
                + productId;
        String url2 = Constants.BASE_URL
                + Constants.GET_SPEC_BY_ID_URL
                + productId;
                ...
                , new Callback() {
                    ...
                    public void onResponse(Call call, Response response) throws IOException {
                        ...
                        try {
                            ...
                            DetailsActivity.this.jsonArr = detail;
