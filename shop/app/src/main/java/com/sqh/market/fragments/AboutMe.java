...
import com.sqh.market.activity.ChatActivity;
import com.sqh.market.activity.MyPosts;
import com.sqh.market.activity.PersonalActivity;
import com.sqh.market.activity.PostsActivity;
...
public class AboutMe extends Fragment {
    ...
    private LinearLayout mBtnPosts, mBtnCart, mBtnBought, mBtnUserInfo, mBtnAbout, mBtnSetting;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        /*菜单们*/
        //发布帖子按钮
        mBtnPosts = view.findViewById(R.id.menu_posts);
        ...
        /*菜单们*/
        //我的帖子按钮
        view.findViewById(R.id.menu_my_posts).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (LoginCheckUtil.isLogin(getActivity())) {
        ...
        /*菜单们*/
        //售后服务按钮
        view.findViewById(R.id.menu_chat).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (LoginCheckUtil.isLogin(getActivity())) {
